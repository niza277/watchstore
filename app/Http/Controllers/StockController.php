...
class StockController extends Controller
{
    ...
    public function save_purchase(Request $request) {
        ...
        for($i = 0; $i < $max-1;$i++)
        {
            ...
            $data['cName'] = $input['data1'][$i]['cName'];
            $data['phone'] = $input['data1'][$i]['phone'];
            $data['cprice'] = $input['data1'][$i]['cprice'];
            $data['mp'] = $input['data1'][$i]['mp'];
            $data['status'] = $input['data1'][$i]['status'];
            $data['remark'] = $input['data1'][$i]['remark'];
        ...
        DB::table('stock_purchases')->insert($data2);
    ...
    public function updateproductDetails(Request $request)
    {
        ...
        //  return $input['data'];
            ...
            $data['cName'] = $input['data']['cName'];
            $data['phonr'] = $input['data']['phone'];
            $data['status'] = $input['data']['status'];
            $data['mp'] = $input['data']['mp'];
            $data['remark'] = $input['data']['remark'];
            $data['cprice'] = $input['data']['cprice'];
